...
<div class="main">
    <form action="doAdminAction.php?act=editCate&id=<?php echo $id ?>" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="cName" placeholder="<?php echo $row['cName']; ?>" autocomplete="off">
        </div>
        <button type="submit" class="btn btn-primary btn-lg btn-block">修改分类</button>
    </form>
</div>
