...
$sql = "select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.iPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName from jx_pro as p join jx_cate c on p.cId=c.id {$orderBy} limit {$offset},{$pageSize}";
$rows = fetch_all($sql);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div id="showDetail<?php echo $row['id']; ?>" style="display:none;">
                        <table class="table" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $proImgs = getAllImageByProId($row['id']);
